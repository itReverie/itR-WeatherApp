package itreverie.weatherapp.sync;
...
import itreverie.weatherapp.data.WeatherContract.WeatherEntry;
import itreverie.weatherapp.main_activity;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        //This is the most important part to implement the code to execute the action
        ...
        String units = "metric";
        int numDays = 14;
        String apkID = "7a688ab24d7854d81b3d2af0772a77bb";
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APK_ID, apkID)
                    .build();
...
//checking the last update and notify if it' the first of the day
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                Intent resultIntent = new Intent(context, main_activity.class);
